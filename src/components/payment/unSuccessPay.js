...
import { getUnSuccessPay } from "../../api/payment";
...
const UnSuccessPay = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const data = await getUnSuccessPay();
            setData(data);
          } catch (error) {
            ...
            <div className={styles.successpaywrapper}>
                ...
                <div className={styles.content + " flex justify-center items-center flex-col mx-auto mb-20 mt-30"}>
                    <div className={styles.text + " flex items-center gap-1 mb-10"}>
                        ...
                        <p className="text-[#f93e3e]">this paying was unsuccess please try again</p>
                    </div>
                    <div>
                        <Link href={"/"}>
                            <BluePrimaryButton>
                    ...
                    {/* <div className={styles.code}>
                        <p className="text-[#27BDBE] text-lg">Reference Number: <span>DF34256</span></p>
                    </div> */}
                </div>
            </div>
        </div>
