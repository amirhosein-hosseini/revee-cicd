  ...
  useEffect(() => {
    ...
    return(
      <>
        <Head>
          {
            categoryData?.follow === true && categoryData?.index === true ? <meta name="robots" content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large" /> :
              categoryData?.follow === true && categoryData?.index === false ? <meta name="robots" content="follow, noindex" /> :
                categoryData?.follow === false && categoryData?.index === true ? <meta name="robots" content="nofollow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large" /> :
                  categoryData?.follow === false && categoryData?.index === false ? <meta name="robots" content="nofollow, noindex" /> : ""
          }
          <link rel="canonical" href={categoryData?.canonical === "" || categoryData?.canonical === null ? `https://healfit.ae/category/${categoryData?.slug}` : categoryData?.canonical} />
          <meta name="description" content={categoryData?.meta_description} />
          <title>{categoryData?.meta_title}</title>
          <script
            type="application/ld+json"
            dangerouslySetInnerHTML={{ __html: categoryData?.schema_markup }}
          />
        </Head>
